...
logDir = os.path.join(root, 'logs') # whatever dir you want to store logs in
    ...
    def errorLog(func=None):
        ...
        def wrapper(*args, **kwargs):
            ...
            try:
                ...
                # return func(*args, **kwargs) # removed for generic road calcs script as it was calling the function again after completing once in main().
