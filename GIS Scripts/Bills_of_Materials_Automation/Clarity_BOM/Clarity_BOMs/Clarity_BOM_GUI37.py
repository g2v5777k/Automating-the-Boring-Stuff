...
def fiber():
    ...
    if not values:
        ...
        sum_length = [len + row[0] for row in arcpy.da.SearchCursor(scratch + '\\' + 'ugFiber_Dissolve', ['LENGTH_GEO'])]
        ws['B2'] = sum_length[0]
    ...
    if not values:
        ...
        sum_length = [len + row[0] for row in arcpy.da.SearchCursor(scratch + '\\' + 'Aerial_Dissolve', ['LENGTH_GEO'])]
        ws['B3'] = sum_length[0]
...
def strand_conduit():
    ...
    if not values:
        ...
        sum_length = [len + row[0] for row in arcpy.da.SearchCursor(scratch + '\\' + 'strandFiber_Dissolve', ['LENGTH_GEO'])]
    ...
    if not values:
        ...
        sum_length = [len + row[0] for row in arcpy.da.SearchCursor(scratch + '\\' + 'strandConduit_Dissolve', ['LENGTH_GEO'])]
